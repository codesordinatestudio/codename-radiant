      ...
      <div className="flex h-16 items-center px-4 md:px-6 gap-4">
        ...
        <div className="flex items-center gap-4 min-w-fit">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-linear-to-br from-cyan-400 to-blue-500 flex items-center justify-center font-bold text-white shadow-sm">
              R
            </div>
            <a href="/" className="font-semibold text-lg hidden sm:block hover: transition-colors">
              Radiant
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-1 ml-2 pl-4 border-l border-base-content/10">
            ...
            <div className="dropdown dropdown-hover">
              <div tabIndex={0} role="button" className="btn btn-xs btn-ghost font-normal px-2">
                v0.1.0
              ...
              >
                <li>
                  <a className="active text-xs bg-base-200 font-medium rounded-lg">v0.1.0</a>
                </li>
              </ul>
            </div>
            ...
            {/* Language Picker */}
            <div className="dropdown dropdown-hover">
              <div tabIndex={0} role="button" className="btn btn-xs btn-ghost  font-medium px-2 gap-1.5">
              ...
              >
                <li className="menu-title px-3 py-1 text-[11px] font-semibold tracking-wider capitalize ">
                  Select Runtime
                </li>
                <li>
                  <a className="active bg-base-200 text-sm font-medium rounded-lg flex items-center justify-between">
                    <span>ts (Bun)</span>
                ...
                <li>
                  <a className=" hover: cursor-default text-sm rounded-lg flex items-center justify-between mt-1">
                    <span>Go</span>
                    <span className="text-[10px] capitalize font-bold tracking-widest /60 bg-gray-100 px-1.5 py-0.5 rounded">
                      Soon
                    </span>
                  </a>
                </li>
                <li>
                  <a className=" hover: cursor-default text-sm rounded-lg flex items-center justify-between">
                    <span>Python</span>
                    <span className="text-[10px] capitalize font-bold tracking-widest /60 bg-gray-100 px-1.5 py-0.5 rounded">
                      Soon
                    </span>
        ...
        <div className="flex items-center gap-6 text-sm font-medium ml-auto">
          <nav className="hidden lg:flex items-center gap-6 ">
            ...
            <a href="/playground" target="_blank" rel="noreferrer" className="hover:text-gray-900 transition-colors">
              Playground
            </a>
          </nav>
        </div>
