...
import { RadiantRouter } from "../../src/main/router";
...
describe("main/router", () => {
  ...
  test("injects CORS headers when configured via toNativeRoutes parameters", async () => {
    ...
    const res = await routes["/test"].GET!(req, null as any);
  ...
  test("validates schemas and rejects invalid query params", async () => {
    ...
    const res = await routes["/api/items"].GET!(req, null as any);
  ...
  test("validates body schema and rejects invalid JSON", async () => {
    ...
    const res1 = await routes["/api/create"].POST!(req1, null as any);
    ...
    const res2 = await routes["/api/create"].POST!(req2, null as any);
    ...
    const res3 = await routes["/api/create"].POST!(req3, null as any);
